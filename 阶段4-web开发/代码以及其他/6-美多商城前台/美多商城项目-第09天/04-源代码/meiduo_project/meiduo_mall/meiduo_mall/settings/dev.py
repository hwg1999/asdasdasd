...
# print(sys.path)
# 追加导包路径指向apps包
# sys.path.insert(0, '/Users/Python/projects/meiduo_project/meiduo_mall/meiduo_mall/apps')
...
DATABASES = {
    'default': {
        ...
        'HOST': '192.168.103.168', # 数据库主机
        'PORT': 3306, # 数据库端口
        'USER': 'itcast_it', # 数据库用户名
...
CACHES = {
    "default": { # 默认
        ...
        "LOCATION": "redis://192.168.103.168:6379/0",
        "OPTIONS": {
    ...
    "session": { # session
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.103.168:6379/1",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "verify_code": { # 验证码
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.103.168:6379/2",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
